...
suite thanks to [@2010YOUY01] that has already found several bugs (kudos to XXX,
...
For example, given a Parquet file with 4 row groups, you can use the
`ParquetAccessPlan` API to specify skipping row group 0 and 2, scanning a range
of rows in row group 1, and scanning all rows in row group 3 as follows:
