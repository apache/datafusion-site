...
displacing DataFusion from the top spot, DataFusion is remains near the top and we [are planing
more improvements].
...
* Uniform Aggregate Functions: `BuiltInAggregateFunctions` was removed and all now used UDFs
