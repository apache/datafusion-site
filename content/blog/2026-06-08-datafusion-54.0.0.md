...
Thanks to [@gstvg] and [@rluvaton] for leading this effort, the [array_filter]
and [array_any_match] functions from [@ologlogn] and [@LiaCastaneda], and reviews
from [@comphead] and [@martin-g].
...
access operator ([#20628]). The
[cosine_distance], [inner_product], and [array_normalize] additions round out
DataFusion's vector-search building blocks. Thanks to [@comphead], [@crm26],
