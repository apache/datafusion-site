...
[Arrow Rust 57.0.0], which is significantly faster parsing Parquet metadata. This is
...
[etseidl] and [jhorstmann] that enabled these improvements 
in the [Faster Apache Parquet Footer Metadata Using a Custom Thrift Parser] blog.
...
You can find more about these new metrics in the [metrics user guide]. Thanks to
