...
| --- | --- |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| --- |
| Runtime row-group pruning for TopK | [#23036], [#22450] | [4.2x faster `topk_tpch` Q8](https://github.com/apache/datafusion/pull/22450#issuecomment-4720594338)                                                                                                                                            | Sort / TopK |
...
| Fewer object store requests for CSV | [#22962] | [70% faster TPC-H CSV with simulated latency](https://github.com/apache/datafusion/pull/22962#issuecomment-4721729807)                                                                                                                             | Scan / IO |
| Faster `SortPreservingMerge` tie-breaker | [#23107] | [8% faster `sort_tpch` Q6](https://github.com/apache/datafusion/pull/23107#issuecomment-4776877963)                                                                                                                                                | Sorting |
...
faster on 200M UUIDs, and the change also addresses a reported out-of-memory
crash when grouping on `FixedSizeBinary` (see [#23645]). Thanks to
