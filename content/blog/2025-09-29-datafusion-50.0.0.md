...
execution plans in DataFusion 50.0.0 with this optimization:
...
Given there is a single customer in this query,
...
For example, to filter the output of the `rank()` function previously
...
users desire Spark compatible functionality in their workloads so DataFusion provides a
...
DataFusion 50.0.0 adds several new such functions, namely:
