...
time. More information can be found in the [Parquet Metadata
Cache](#parquet-metadata-cache) section.
...
Given there are some minor issues that have been discovered after the release of `50.0.0`, we already have a hot fix planned (`50.1.0`). Users can track the progress in this [ticket](https://github.com/apache/datafusion/issues/17594). 
