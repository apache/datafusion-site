...
will aim to introduce them to other types. The following example shows how
...
source, keeping the data loaded at a minimum.

The result is an order of
...
We do not anticipate the need to turn them off.
