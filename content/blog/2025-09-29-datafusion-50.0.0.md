...
improvement in execution time and 99% less memory usage. More details and
...
Given that there is a single customer in this query,
...
filter it right at the source, keeping the amount of data loaded to a minimum.
